...
from shared import lang_import,command_import,user_import
import shared
        ...
        if ("sudo" in command and (("--rootin" in command) or ("--system" in command))) or (not use_uac):
            if package=="ubuntu":
                ...
                if hash(uac.encode("utf-8"))=="6f8c43dfc850e125fe7345d24a04c83edad33604bc3fa6f2b868cd8cee80dbb7":
                    ...
                    special.empty(randint(10000,100000))
                    print("> [Main] https://github.com... done")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://www.github-zh.com... bad")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://kkgithub.com... bad")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://bgithub.xyz... done")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://github.com.cnpmjs.org... done")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://gitcode.net... done")
                    special.empty(randint(10000,100000))
                    print("> [Mirror] https://gitclone.com... bad")
