...
<h1 id="main"></h1><!--啊，我定义了一个没用的h1，那么它可以拿来干什么呢？这个就得靠你们了awa-->
<details>
...
2. **<p id="license">新功能**  
    ...
    修订license文件，换上了更开放的OCL</p><!--WOC成了？！-->
...
> 我们正在重写<a href="#license">license文件</a>。在将来，原有的license文件将会弃用。

<a href="#winux-alpha-25070513-update-dialog">回到主要内容</a>
